 ...
 */
final class Version20220508183915 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorys CHANGE enAvant en_avant INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorys CHANGE en_avanten_avant enAvant INT DEFAULT NULL');
    }
}
