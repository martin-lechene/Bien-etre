...
class ServiceCategory
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Images::class, mappedBy="ServiceCategoryID")
     */
    private $images;

    /**
     * @ORM\ManyToMany(targetEntity=Promotion::class, mappedBy="serviceCategoryID")
     */
    private $promotions;

    /**
     * @ORM\ManyToMany(targetEntity=Propose::class, mappedBy="servicesCategoryID")
     */
    private $proposes;
    ...
    public function addImage(Images $image): self
    {
        if (!$this->images->contains($image)) {
            $this->images[] = $image;
            $image->addServiceCategoryID($this);
        }
    ...
    public function removeImage(Images $image): self
    {
        if ($this->images->removeElement($image)) {
            $image->removeServiceCategoryID($this);
        }
    ...
    public function addPromotion(Promotion $promotion): self
    {
        if (!$this->promotions->contains($promotion)) {
            ...
            $promotion->addServiceCategoryID($this);
        }
    ...
    public function removePromotion(Promotion $promotion): self
    {
        if ($this->promotions->removeElement($promotion)) {
            $promotion->removeServiceCategoryID($this);
        }
    ...
    public function addPropose(Propose $propose): self
    {
        if (!$this->proposes->contains($propose)) {
            ...
            $propose->addServicesCategoryID($this);
        }
    ...
    public function removePropose(Propose $propose): self
    {
        if ($this->proposes->removeElement($propose)) {
            $propose->removeServicesCategoryID($this);
        }
